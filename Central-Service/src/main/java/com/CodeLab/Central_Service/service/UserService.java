...
public class UserService {
    ...
    public void registerUser(UserRequestDTO userRequestDTO){
        ...
        IsUserAlreadyPresentResponseDTO responseDTO = dbService.callIsUserEmailAlreadyExists(email);
...
//        System.out.println(message);
    ...
    public OTPVerificationResponseDTO verifyOtp(UserRequestDTO requestDTO,String otp){
        ...
        OTPVerificationResponseDTO responseDTO = dbService.callVerifyOtp(requestDTO,otp);
